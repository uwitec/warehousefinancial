...
import com.wfms.model.common.datastat.StatRuleEntity;
 ...
 * <dd> 类名称：CommonStatDAO
 * <dd> 类描述：通用统计DAO
 * <dd> 创建人：Administrator
 * <dd> 创建时间：Mar 4, 2010 2:02:15 PM
 * <dd> 修改人：无
 * <dd> 修改时间：无
 * <dd> 修改备注：无
 * </dl>
...
public class CommonStatDAO extends ExtDao {
	...
	public StatRuleEntity getRuleByTabColumn(String tableName,String colName)
	{
		String queryHql="FROM StatRuleEntity where ssbmc=:ssbmc and zdmc=:zdmc";
		Map<String,String> queryParams=new HashMap<String, String>(2);
		queryParams.put("ssbmc",tableName);
		queryParams.put("zdmc",colName);
		return (StatRuleEntity)super.executeScalar(queryHql,queryParams);
	}
	...
	public boolean initStatResultSetBean(StatUtil statUtil,StatResultSetBean rsBean,StatConditionBean condBean) {
		...
		StatRuleEntity columnRule = getRuleByTabColumn(tableName, columnKeyType);
		StatRuleEntity rowRule = getRuleByTabColumn(tableName, rowKeyType);
	...
	public StatRuleEntity getStatRuleBySsbmcZd(String tableName,String zdmc)
	{
		String queryHql="FROM StatRuleEntity where ssbmc=:ssbmc and zdmc=:zdmc";
		Map<String, String> queryParams = new HashMap<String, String>(2);
		queryParams.put("ssbmc", tableName);
		queryParams.put("zdmc", zdmc);
		StatRuleEntity statRule = (StatRuleEntity)super.executeScalar(queryHql, queryParams);
		return statRule;
	}
