...
<%@ include file="/WEB-INF/views/common/head.jsp"%>
	...
	<script type="text/javascript">
		Ext.onReady(function(){
			...
			var g = new Ext.Panel({
				id: "ShowQxkb",
                title: "从&nbsp;&nbsp;<%=stime %>&nbsp;&nbsp;到&nbsp;<%=etime %>，公司费用统计",
                border: false,
                layout:'fit',
                autoScroll:true,
                autoLoad: {
                    url: contextPath + "/jxc/QueryAction.do?method=getMon&ftime="+st+"&etime="+et,
                    method: "Post"
                }
            });
			//添加列表
				...
				buttons:[
					{
						...
						handler:function(){
							...
							window.location.href = contextPath + "/jxc/QueryAction.do?method=getInitMon&ftime="+st+"&etime="+et+"";
						}
					},{
						text:'重 置',
						handler:function(){
