	...
	<script type="text/javascript">
		Ext.onReady(function(){
			...
			var xhgzData = new Ext.data.JsonStore({
		        ...
		        url: contextPath+'/system/jcsdAction.do?method=getQtdm&dmlb=bjmcscgz',
				fields:[
					{
						name:'dmjc'
					},{
			...
			var dataStore = new Ext.data.JsonStore({
				autoDestroy: true,
		        url: 'bhscgzglAction.do?method=getAllBhscgz&name=bjmcscgz',
				fields:["id","tjid","zdws","qsw","ws","sfbl","clz","scgzmc","scsx","qsxh"]
			});
			var mainFrame = new MianFrame();
			setNavigate("系统管理 >> 基础设定 >> 班级名称生成规则","本模块提供维护班级名称生成规则功能，作为自动分班基础数据");
