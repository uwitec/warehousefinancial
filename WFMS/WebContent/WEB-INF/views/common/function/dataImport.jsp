				...
				items:[
					{
	                    ...
	                    height:40,
	                    margins:'0 4 0 4',
						html:'<table width="100%" height="100%"><tr><td width="20" rowspan="2"><img height="40" width="45" src="<c:url value="/imgs/navigate.png"/>"/></td><td style="font-size:13px;padding-left:5px;color:#15428b;font-weight:bold">综合功能 >> 数据导入</td></tr><tr><td style="font-size:11px;padding-left:5px;color:#15428b;">该模块为用户提供方便的导入形式，用户可根据自己的需求导入数据</td></tr></table>'
	                },{
						xtype:'panel',
						region:'east',
						title:'相关操作',
						...
						items:[
							{
								...
								items: new Ext.Panel({
									region:'center',
									border:false,
									html:'<iframe width="100%" height="100%" frameborder="0" src="<c:url value="function/dataImport_x.html"/>"></iframe>'
								})
							}
						]
					}
