...
import com.wfms.webapp.common.dataimport.attribute.ImportFields;
...
public abstract class DataImportHandler {
	...
	protected List<ColumnEntity> colEntList = null;
	protected List<DrgzEntity> drgzList = null;
	...
	public List<ColumnEntity> getColEntList() {
		return colEntList;
	}

	public void setColEntList(List<ColumnEntity> colEntList) {
		this.colEntList = colEntList;
	}

	public List<DrgzEntity> getDrgzList() {
		return drgzList;
	}

	public void setDrgzList(List<DrgzEntity> drgzList) {
