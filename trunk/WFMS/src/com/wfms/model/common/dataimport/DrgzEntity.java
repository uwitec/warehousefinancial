package com.wfms.model.common.dataimport;
 ...
 *
 */
public class DrgzEntity  implements java.io.Serializable {
	...
	/** minimal constructor */
    public DrgzEntity(String zdmc, String zdlx, String ssbmc, String wbsjz, String nbsjz) {
        this.zdmc = zdmc;
        this.zdlx = zdlx;
        this.ssbmc = ssbmc;
        this.wbsjz = wbsjz;
    ...
    /** full constructor */
    public DrgzEntity(String zdmc, String zdlx, String ssbmc, String wbsjz, String nbsjz, String ckb, String wbsjckzd, String nbsjckzd, String fllxdm) {
        this.zdmc = zdmc;
        this.zdlx = zdlx;
        this.ssbmc = ssbmc;
        this.wbsjz = wbsjz;
